<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Employee.aspx.cs" Inherits="MahadevEnterprise.Employee" %>
                        ...
                        <asp:Panel ID="ListPanel" runat="server">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <asp:GridView ID="GridCategory" class="table table-bordered table-striped dataTable dtr-inline"
